...
# contains all objects for preprocessing data that have been previously created
...
# Create the data_preprocessing() function. This function will be used to run the data preprocessing process.
